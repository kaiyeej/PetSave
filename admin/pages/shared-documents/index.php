            ...
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body px-5">
                    ...
                    <div
                        ...
                        <!--begin:Item-->
                        <div class="navi-item my-2">
                            <a href="#" onclick="getDocType(-2)" id="nav_pending"  class="navi-link">
                                <span class="navi-icon mr-4">
                                    <i class="fa fa-genderless text-danger"></i>
                                </span>
                                <span class="navi-text font-weight-bolder font-size-lg">Pending Invintation</span>
                            </a>
                        </div>
                        <!--end:Item-->
...
function getDocType(doc_type_id){
    ...
    $.ajax({
        type: 'POST',
        url:  "controllers/sql.php?c=Documents&q=docByTypeShared",
        data: {
