...
-- Dumping database structure for petadoption_db
CREATE DATABASE IF NOT EXISTS `petadoption_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `petadoption_db`;

-- Dumping structure for table petadoption_db.tbl_adoption
...
-- Dumping data for table petadoption_db.tbl_adoption: ~3 rows (approximately)
...
-- Dumping structure for table petadoption_db.tbl_lost_and_found
...
-- Dumping data for table petadoption_db.tbl_lost_and_found: ~3 rows (approximately)
...
-- Dumping structure for table petadoption_db.tbl_pets
...
-- Dumping data for table petadoption_db.tbl_pets: ~5 rows (approximately)
...
-- Dumping structure for table petadoption_db.tbl_posts
...
-- Dumping data for table petadoption_db.tbl_posts: ~6 rows (approximately)
...
-- Dumping structure for table petadoption_db.tbl_rehab
CREATE TABLE IF NOT EXISTS `tbl_rehab` (
...
-- Dumping data for table petadoption_db.tbl_rehab: ~0 rows (approximately)

-- Dumping structure for table petadoption_db.tbl_rescue
CREATE TABLE IF NOT EXISTS `tbl_rescue` (
...
-- Dumping data for table petadoption_db.tbl_rescue: ~0 rows (approximately)

-- Dumping structure for table petadoption_db.tbl_users
...
-- Dumping data for table petadoption_db.tbl_users: ~11 rows (approximately)
