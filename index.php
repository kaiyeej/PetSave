...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="admin/assets/media/logos/logo.png">
...
<body>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="logo">
                                <a href="./">
                                    <img src="admin/assets/media/logos/logo.png" height="100px">
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            <p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved Team
                            </p>
                        </p>
                    </div>
                </div>
    ...
    <script src="admin/assets/sweetalert/sweetalert.js"></script>
    ...
    <script>
        ...
        function success_add_adopt() {
            swal("Success!", "Successfully submitted adoption application! ", "success");
        }

        function failed_query(data) {
            swal("Something is wrong. Failed to execute query!", data, "warning");
        }
