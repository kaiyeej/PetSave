                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-item" name="input[fullname]" id="doc_name" autocomplete="off" placeholder="Full name" required>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>1. What prompted you to adopt from PAWS? <span class="text-danger">*</span></label>
