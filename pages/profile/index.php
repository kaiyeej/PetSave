...
<div class="d-flex flex-column-fluid">
  ...
  <div class="container ">
    ...
    <div class="row">
              ...
              <form method='POST' id='frm_profile' class="profile">
                <div class="row">
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" autocomplete="off" class="form-control input-item" id="user_contact_num" name="input[user_contact_num]" placeholder="Contact number">
                  </div>
                  ...
                  <input type="hidden" autocomplete="off" value="<?= $_SESSION['cdms_user_id'] ?>" name="input[user_id]" class="form-control" id="hidden_id">
                  <div class="form-group col-sm-6">
      ...
      <div class="col-lg-4">
        <div class="card card-custom" style="border: 1.5px #ff5722 dotted;">
          <div class="card-body">
...
<script type="text/javascript">
  getProfile("<?= $_SESSION['cdms_user_id'] ?>");
